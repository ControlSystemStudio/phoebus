...
public class ConfigurationSelectionWithSplitController extends BaseConfigurationSelectionController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        treeView.getSelectionModel().selectedItemProperty().addListener((observableValue, nodeTreeItem, selectedTreeItem) -> {
            ...
            if (!savesets.isEmpty() && !isDisabledConfigurationSelection) {
