...
public class ValueUtil {
    ...
    private static Collection<Class<?>> types = Arrays.<Class<?>>asList(VByte.class, VByteArray.class, VDouble.class,
            ...
            VLong.class, VLongArray.class, VInt.class, VIntArray.class,
             VShort.class, VShortArray.class,
    ...
    public static Time latestValidTimeOrNowOf(final List<Object> args) {
        ...
        for (Object object : args) {
            ...
            if (object != null)  {
                newTime = ValueUtil.timeOf(object);
                if (newTime != null && newTime.isValid() && (finalTime == null || newTime.getTimestamp().compareTo(finalTime.getTimestamp()) > 0)) {
                    finalTime = newTime;
                }
            }
        }
    ...
    public static Display displayOf(Object obj) {
        ...
        if (display.getAlarmRange() == null || display.getDisplayRange() == null)
            return null;
        return display;
    }
    ...
    public static boolean displayHasValidDisplayLimits(Display display) {
        return display.getDisplayRange() != null;
    }
    ...
    public static Double normalize(Number value, Display display) {
        ...
        return (value.doubleValue() - display.getDisplayRange().getMinimum()) / (display.getDisplayRange().getMaximum() - display.getDisplayRange().getMinimum());
    }
    ...
    public static boolean displayEquals(Display d1, Display d2) {
        ...
        if (Objects.equals(d1.getFormat(), d2.getFormat()) &&
                Objects.equals(d1.getUnit(), d2.getUnit()) &&
                Objects.equals(d1.getDisplayRange(), d2.getDisplayRange()) &&
                Objects.equals(d1.getAlarmRange(), d2.getAlarmRange()) &&
                Objects.equals(d1.getWarningRange(), d2.getWarningRange()) &&
                Objects.equals(d1.getControlRange(), d2.getControlRange())) {
            return true;
        }
