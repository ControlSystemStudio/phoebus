...
public class RTProgressBarRepresentation extends RTScaledWidgetRepresentation<ProgressBarWidget>
{
    ...
    {
        // The stock ProgressBar has a plain track, without the tank's
        // shaded gradient for the empty region
    ...
    {
        applyScaleLook();
        // Background and empty color are the same so the unfilled part of
        // the bar blends with the margin, like the stock progress bar track
