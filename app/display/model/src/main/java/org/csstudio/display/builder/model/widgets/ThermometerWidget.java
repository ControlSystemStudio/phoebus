...
public class ThermometerWidget extends ScaledPVWidget
{
    ...
    private volatile WidgetProperty<Integer>     bulb_size;
    ...
    protected void defineProperties(final List<WidgetProperty<?>> properties)
    {
        ...
        properties.add(bulb_size        = propBulbSize.createProperty(this, 20));
    }
    ...
    public WidgetProperty<Integer> propInnerPadding()                 { return inner_padding; }

    /** @return 'bulb_size' property */
    public WidgetProperty<Integer> propBulbSize()                     { return bulb_size; }
}
