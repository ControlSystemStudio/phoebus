...
public class ThermometerWidgetUnitTest
{
    ...
    public void testDefaults()
    {
        ...
        assertThat(thermo.propInnerPadding().getValue(), equalTo(3));
    ...
    public void testXmlRoundTrip() throws Exception
    {
        ...
        original.propInnerPadding().setValue(0);
        original.propBulbSize().setValue(35);
        original.propBackgroundColor().setValue(new WidgetColor(1, 2, 3));
        ...
        assertThat(thermo.propInnerPadding().getValue(), equalTo(0));
        assertThat(thermo.propBulbSize().getValue(), equalTo(35));
        assertThat(thermo.propBackgroundColor().getValue(), equalTo(new WidgetColor(1, 2, 3)));
    ...
    private static String write(final Widget widget, final boolean skip_defaults) throws Exception
    {
        final DisplayModel model = new DisplayModel();
        model.runtimeChildren().addChild(widget);
        final ByteArrayOutputStream out = new ByteArrayOutputStream();
        final boolean saved = ModelWriter.skip_defaults;
        ModelWriter.skip_defaults = skip_defaults;
