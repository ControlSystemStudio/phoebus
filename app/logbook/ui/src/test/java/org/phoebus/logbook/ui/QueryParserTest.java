...
public class QueryParserTest {
    ...
    public void timeParsing() {
        ...
        assertEquals(now/1000, Double.parseDouble(queryParameters.get(Keys.ENDTIME.getName())), 60);
        assertEquals((now-(8*60*60*1000))/1000, Double.parseDouble(queryParameters.get(Keys.STARTTIME.getName())), 60);
    }
