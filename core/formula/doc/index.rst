...
elements of the input argument list must be of either VString or VNumber.
...
Returns a VNumberArray or VStringArray that is a sub-array defnined by the fromIndex
