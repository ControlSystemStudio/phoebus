...
public class ValueHelper
{
    ...
    public static VType getInitialValue(final List<String> items, Class<? extends VType> type) throws Exception
    {
        ...
        // TODO There is no VStringArray
//        if (type == VStringArray.class)
//            return VStringArray.of(getInitialStrings(items));
        ...
        if (type == VDouble.class)
        {
            ...
            catch (NumberFormatException ex)
            {
                ...
                {   // Change to string?
                    ...
                    // TODO Implement when VStringArray available
//                    if (new_value instanceof String[])
//                        return ValueFactory.newVStringArray(Arrays.asList((String[]) new_value), Alarm.none(), Time.now());
//                    if (new_value instanceof List)
//                    {   // Assert each list element is a String
//                        final List<String> strings = new ArrayList<>();
//                        for (Object item : (List<?>)new_value)
//                            strings.add(Objects.toString(item));
//                        return ValueFactory.newVStringArray(strings, Alarm.none(), Time.now());
//                    }
                }
...
//          new_type = VStringArray.class;
        ...
        // TODO Implement when VStringArray is again available
//        if (type == VStringArray.class)
//        {   // Pass String
//            if (new_value instanceof String)
//                return ValueFactory.newVStringArray(Arrays.asList((String) new_value), Alarm.none(), Time.now());
