...
public class Macros2UnitTest
{
    /** Test check of macro name */
    @Test
    public void testNames()
    {
        assertThat(Macros2.checkMacroName("ExampleMacro"), nullValue());
        assertThat(Macros2.checkMacroName("My_Macro"), nullValue());
        assertThat(Macros2.checkMacroName("My-Macro"), nullValue());
        assertThat(Macros2.checkMacroName("Macro2"), nullValue());

        assertThat(Macros2.checkMacroName("2MustStartWithCharacter"), not(nullValue()));
        assertThat(Macros2.checkMacroName("-CannotHaveNon-CharacterAtStart"), not(nullValue()));
        assertThat(Macros2.checkMacroName("No Spaces"), not(nullValue()));
    }
