-- Those columns are INTEGER in PostgreSQL
-- ALTER TABLE config_pv_relation ALTER COLUMN config_id BIGINT UNSIGNED;
-- ALTER TABLE node_closure ALTER COLUMN ancestor BIGINT UNSIGNED;
-- ALTER TABLE node_closure ALTER COLUMN descendant BIGINT UNSIGNED;
-- ALTER TABLE property ALTER COLUMN node_id BIGINT UNSIGNED;
-- ALTER TABLE snapshot_node_pv ALTER COLUMN snapshot_node_id BIGINT UNSIGNED;
-- ALTER TABLE snapshot_node_pv ALTER COLUMN config_pv_id BIGINT UNSIGNED;
