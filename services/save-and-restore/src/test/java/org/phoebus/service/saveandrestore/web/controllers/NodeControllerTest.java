...
public class NodeControllerTest {
	...
	public void testGetFolder() throws Exception {
		when(nodeDAO.getNode("q")).thenReturn(Node.builder().id(1).uniqueId("q").build());
	...
	public void testMoveNode() throws Exception {
		when(nodeDAO.moveNodes(Arrays.asList("a"), "b", "username")).thenReturn(Node.builder().id(2).uniqueId("a").build());
